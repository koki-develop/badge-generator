  ...
  return (
    <select
      ...
      className={classNames(
        ...
        "rounded-sm border p-2 outline-hidden hover:bg-gray-50"
      )}
    >
      {options.map((option) => (
  ...
  return (
    <div className={classNames(className)}>
      ...
      <span className="flex">
        {withCopy && (
          <button
            className="rounded-l border border-r-0 px-3 outline-hidden hover:bg-gray-50 active:bg-gray-100"
            onClick={handleCopy}
          >
            {copied ? (
        ...
        {inputProps.type == "text" && (
          <input
            ...
            className={classNames(
              inputClassname,
              "rounded-r border p-2 outline-hidden",
              {
                "w-full": fullWidth,
                rounded: !withCopy,
